# IWant100
## 🔥 실시간 투표 시스템 개발 프로젝트 🔥
Firebase를 이용한 실시간 투표 시스템은 사용자가 투표를 생성하고 다른 사용자들이 실시간으로 참여할 수 있다. 이 시스템을 통해 다양한 주제에 대해 의견을 수렴하고 결과를 즉시 확인할 수 있다.
## ❗️ 구현 목적 ❗️
Firebase를 통해 실시간 투표 앱을 개발하면서 Firebase에 대한 이해와 React에 대한 이해를 향상시키고자 한다.
## ⭐️ 주요 기능 ⭐️
### 투표 생성
...
### 사용자 인증
- Firebase Authentication을 사용하여 사용자를 인증할 수 있다.
...
- Firebase Realtime Database or Firestore: 투표와 투표 결과를 저장하고 실시간으로 동기화한다.
